...
import edu.tectii.stepcounter6.Database;
...
abstract class Dialog_Statistics {
	...
	public static Dialog getDialog(final Context c, int since_boot) {
		//para solicitar al sistema que incluya o excluya algunas de las funciones de Windows (barra de herramientas,
		// barra de acciones, etc.).
		//para hacer una ventana de pantalla completa
        ...
        //para traer dela base de datos el record que hiciste en en los dias
