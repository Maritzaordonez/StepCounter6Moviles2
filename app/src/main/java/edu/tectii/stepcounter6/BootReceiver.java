...
// este es un servicio que se encarga de registrar eventos que se produzcan en el SO Android
public class BootReceiver extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, final Intent intent) {
        ...
        //la última entrada aún podría tener un valor de paso negativo y lo que hace es removerlo de la base de datos
